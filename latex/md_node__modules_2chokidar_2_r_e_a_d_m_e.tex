...
\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e}{}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e}\index{Chokidar $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dw/chokidar.svg"{} alt="{}Weekly downloads"{}/$>$$<$/a$>$ $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dy/chokidar.svg"{} alt="{}Yearly downloads"{}/$>$$<$/a$>$@{Chokidar $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dw/chokidar.svg"" alt=""Weekly downloads""/$>$$<$/a$>$ $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dy/chokidar.svg"" alt=""Yearly downloads""/$>$$<$/a$>$}}
\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md260}%
\Hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md260}%
 \begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}
\href{https://www.npmjs.com/package/chokidar}{\texttt{ }}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md261}{}\doxysection{\texorpdfstring{Why?}{Why?}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md261}
...
Version 3 is out! Check out our blog post about it\+: \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{ Chokidar 3\+: How to save 32TB of traffic every week}}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md262}{}\doxysection{\texorpdfstring{How?}{How?}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md262}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md264}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md264}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md265}{}\doxysubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md265}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md266}{}\doxysubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md266}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md267}{}\doxysubsubsection{\texorpdfstring{Performance}{Performance}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md267}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md268}{}\doxysubsubsection{\texorpdfstring{Errors}{Errors}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md268}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md269}{}\doxysubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md269}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md270}{}\doxysection{\texorpdfstring{CLI}{CLI}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md270}
If you need a CLI interface for your file watching, check out \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{ chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md271}{}\doxysection{\texorpdfstring{Install Troubleshooting}{Install Troubleshooting}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md271}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md272}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md272}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md273}{}\doxysection{\texorpdfstring{Also}{Also}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md273}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four).\hypertarget{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md274}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md274}
