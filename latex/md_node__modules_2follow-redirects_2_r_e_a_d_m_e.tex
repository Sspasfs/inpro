...
\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e}{}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e}\index{Follow Redirects@{Follow Redirects}}
\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md324}%
\Hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md324}%
...
\end{DoxyCode}
\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md325}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md325}
\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md326}{}\doxysubsection{\texorpdfstring{Global options}{Global options}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md326}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md327}{}\doxysubsection{\texorpdfstring{Per-\/request options}{Per-\/request options}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md327}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md328}{}\doxysubsection{\texorpdfstring{Advanced usage}{Advanced usage}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md328}
...
Such custom protocols only need an implementation of the {\ttfamily request} method.\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md329}{}\doxysection{\texorpdfstring{Browser Usage}{Browser Usage}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md329}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md330}{}\doxysection{\texorpdfstring{Contributing}{Contributing}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md330}
Pull Requests are always welcome. Please \href{https://github.com/follow-redirects/follow-redirects/issues}{\texttt{ file an issue}} detailing your proposal before you invest your valuable time. Additional features and bug fixes should be accompanied by tests. You can run the test suite locally with a simple {\ttfamily npm test} command.\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md331}{}\doxysection{\texorpdfstring{Debug Logging}{Debug Logging}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md331}
{\ttfamily follow-\/redirects} uses the excellent \href{https://www.npmjs.com/package/debug}{\texttt{ debug}} for logging. To turn on logging set the environment variable {\ttfamily DEBUG=follow-\/redirects} for debug output from just this module. When running the test suite it is sometimes advantageous to set {\ttfamily DEBUG=\texorpdfstring{$\ast$}{*}} to see output from the express server as well.\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md332}{}\doxysection{\texorpdfstring{Authors}{Authors}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md332}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md333}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2follow-redirects_2_r_e_a_d_m_e_autotoc_md333}
